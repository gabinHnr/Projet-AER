...
def safe_import(module_path):
    try:
        ...
        # Si erreur de syntaxe (le ?) ou autre, on renvoie None
        return None
...
joueur1 = Player(100, 460, (255, 0, 0), 
                {'left': K_q, 'right': K_d, 'jump': K_z, 'shoot': K_a}, "Player 1")
joueur2 = Player(800, 460, (0, 0, 255), 
                {'left': K_LEFT, 'right': K_RIGHT, 'jump': K_UP, 'shoot': K_DOWN}, "Player 2")
...
print("Système Epi Dash activé. En attente de la réparation des modules...")
...
while True:
    ...
    for joueur in joueurs:
        dx = 0
        # On n'exécute les étapes que si le module a été chargé (sans ?)
        if step1:
